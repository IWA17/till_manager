...
{
    /**
     * @var \Andbios\TillManager\Controller\ProductController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\Andbios\TillManager\Controller\ProductController::class)
    ...
    public function listActionFetchesAllProductsFromRepositoryAndAssignsThemToView()
    {
        ...
        $productRepository = $this->getMockBuilder(\Andbios\TillManager\Domain\Repository\ProductRepository::class)
            ->setMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
